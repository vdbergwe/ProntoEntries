...
Namespace Controllers
    Public Class RaceEventsController
        ...
        <Authorize>
        Function Create(<Bind(Include:="RaceID,RaceName,RaceDescription,RaceDate,RaceType,Coordinates,Address,City,Province,AdminCharge,OrgID,Image,Background,ImgDetail1,ImgDetail2,ImgDetail3,DispClasses,DispAdmCharge,DispAddress,RaceHtmlPage,Indemnity,TandC,EntriesCloseDate,PF_ToClient,Admin_ToClient,Admin_Rate")> ByVal raceEvent As RaceEvent, imgFile2 As HttpPostedFileBase, imgBackground As HttpPostedFileBase) As ActionResult
        ...
        <Authorize>
        <ValidateAntiForgeryToken()>
        Function Edit(<Bind(Include:="RaceID,RaceName,RaceDescription,RaceDate,RaceType,Coordinates,Address,City,Province,AdminCharge,OrgID,Image,Background,ImgDetail1,ImgDetail2,ImgDetail3,DispClasses,DispAdmCharge,DispAddress,RaceHtmlPage,Indemnity,TandC,EntriesCloseDate,PF_ToClient,Admin_ToClient,Admin_Rate")> ByVal raceEvent As RaceEvent, imgFile2 As HttpPostedFileBase, imgBackground As HttpPostedFileBase, imgdetailfirst As HttpPostedFileBase, imgdetailsecond As HttpPostedFileBase, imgdetailthird As HttpPostedFileBase) As ActionResult
